...
public class SpielerBewegung {
        ...
        private void spielerBewegt() {
                ...
                case Juwelier:
                        feldaktionen.betreteJuwelier(alleSpieler.get(aktuellerSpielerIndex),frame);
                        break;
                case Buchhandlung:
                    feldaktionen.betreteBuchhandlung(alleSpieler.get(aktuellerSpielerIndex),frame);
                    break;
                case Schmiede:
                    feldaktionen.betreteSchmiede(alleSpieler.get(aktuellerSpielerIndex),frame);
                    break;
                case BAUM:
