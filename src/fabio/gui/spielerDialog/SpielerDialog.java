...
public class SpielerDialog extends Dialog {
    ...
    private void initListeners() {	
    	...
    	jButton2.addActionListener(new ActionListener() {
			...
			if(vorhanden) {
				...
				jLabel10.setVisible(false);
				s.spielerAdd(Spieler.createSpieler(jTextField1.getText().trim(), bestimmePos(s.getSpielerAnzahl()), bestimmeColor(), jComboBox1.getSelectedItem().toString(), beleg));	
				defaultText();
    ...
    private Color bestimmeColor() {
    		...
    		case "Blau":
    			...
    			return Color.blue;
    		case "Pink":
    			farbenList.remove(farbenList.indexOf("Pink"));
    			bdm.removeElementAt(jComboBox2.getSelectedIndex());
    			return Color.pink;
    		case "Gelb":
