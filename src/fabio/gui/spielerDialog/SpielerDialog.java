...
public class SpielerDialog extends Dialog {
    ...
    private String[] farben = new String[] { "Rot", "Blau", "Pink", "Gelb" };      
    ...
    private void initListeners() {	
    			...
    			System.out.println("click");
    					...
    					tf.addKeyListener(new KeyAdapter() {
    						...
    						public void keyPressed(KeyEvent e) {
    							...
    							System.out.println(beleg[key.indexOf(e.getComponent())]);
    							tf.setText(in);
    	...
    	jButton2.addActionListener(new ActionListener() {
			...
			if(s.gibtNamen(jTextField1.getText())) {
				s.spielerAdd(Spieler.createSpieler(jTextField1.getText(), bestimmePos(s.getSpielerAnzahl()), bestimmeColor(), jComboBox1.getSelectedItem().toString(), beleg));	
				defaultText();
    ...
    private Color bestimmeColor() {
    		switch(farben[jComboBox2.getSelectedIndex()]) {
    		case "Rot":
