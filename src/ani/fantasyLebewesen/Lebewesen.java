...
public abstract class Lebewesen { 
	...
	protected int hpmax;
	protected int hp;
	public abstract int lootGold();
	public abstract Consumeables lootConsu();
	public abstract Item lootExtra();
	protected boolean gelaehmt;
	...
	public boolean getGelaehmt() {
		return gelaehmt;
	}
	public void setGelaehmt(boolean lahm) {
		this.gelaehmt = lahm;
	}
